...
用latex需要安装什么，需要安装texlive，外加一个IDE
...
已经出2022了，2023也快了，一般四月份，别更新，我不一定会去适配2023texlive，可以用兰大的镜像下载应该在用校园网时快一些，额，你还是用清华的镜像吧，我刚才找了一下，兰大镜像这会儿竟然挂了。。。
...
3. 配置vscode：
   ...
   注意：你复制的内容下面有一个右大括号 `}` ，复制的内容前面有一个英文逗号`,` ; 复制下面的内容以后，
...
4. 配置成功以后的界面：
    ...
    注意配置以后要打开vscode，再点开一个.tex文件，左侧才会出现 `Tex` 选项
